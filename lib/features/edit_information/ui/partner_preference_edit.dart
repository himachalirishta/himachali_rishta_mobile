              ...
              child: ListView(
                children: [
                  ...
                  GestureDetector(
                    ...
                    child: TextField(
                      enabled: false,
                      controller: getController.employmentTypeController,
                      obscureText: false,
                      textAlign: TextAlign.start,
                      maxLines: 1,
                      style: TextStyle(
                  ...
                  GestureDetector(
                    ...
                    child: TextField(
                      enabled: false,
                      controller: getController.annualIncomeController,
                      obscureText: false,
                      textAlign: TextAlign.start,
                      maxLines: 1,
                      style: TextStyle(
                        ...
                        onOptionSelected: (index) {
                          switch (getController.selectedOptionIndex.value) {
                            ...
                            case 3:
                              ...
                              getController.lookingForController.text =
                                  getController.selectedLookingFor.value;
                            ...
                            //Employment Type
                            case 5:
                              getController.selectedEmploymentType.value =
                                  getController.employmentType[index];
                              getController.employmentTypeController.text =
                                  getController.selectedEmploymentType.value;
                            ...
                            //Annual Income
                            case 6:
                              getController.selectedAnnualIncome.value =
                                  getController.annualIncome[index];
                              getController.annualIncomeController.text =
                                  getController.selectedAnnualIncome.value;
                            ...
                            //Living Country
                            case 8:
                              getController.selectedLivingCountry.value =
                                  getController.livingCountry[index];
                              getController.livingCountryController.text =
                                  getController.selectedLivingCountry.value;
                            ...
                            //Living State
                            case 9:
                              getController.selectedLivingState.value =
                                  getController.livingState[index];
                              getController.livingStateController.text =
                                  getController.selectedLivingState.value;
                            ...
                            case 10:
                              ...
                              getController.livingCityController.text =
                                  getController.selectedLivingCity.value;
